...
export const supportBanner = {
  ...
  description:
    "도움이 되었다면 원하는 만큼 응원해 주세요. 응원 키트는 100% 선택이며, 자료 이용에 전혀 영향을 주지 않습니다.",
  cta: "응원 키트 받기",
  href: "/support",
};
...
export const support = {
  ...
  titleAccent: "감사합니다",
  description:
    "이곳의 모든 자료와 서비스는 누구나 무료로 쓸 수 있는 교육 자원입니다. 응원 키트는 전적으로 선택이에요 — 부담 없이, 마음이 닿는 만큼만.",
  ...
  share: {
    ...
    description: "응원 키트보다 더 큰 힘은, 이 자료가 필요한 사람에게 닿는 거예요.",
  },
};
